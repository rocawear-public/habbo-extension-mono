 ...
 * @internal
 */
export declare type CreateRouterInner<TConfig extends AnyRootConfig, TProcRouterRecord extends ProcedureRouterRecord> = Router<RouterDef<TConfig, TProcRouterRecord>> & TProcRouterRecord;
/**
 * @internal
 */
